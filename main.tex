...
\[
X(f) = h(\operatorname{grad}_h f, X) = g(\operatorname{grad}_h \ln f, X)
\]
recalling that $g = (1/f)h$. We then compute
\[
\begin{split}
\hat{\nabla}_{\xi} \left(X(f)\right) &= \hat{\nabla}_{\xi} \left(g(\operatorname{grad}_h \ln f, X)\right) \\
&= (\hat{\nabla}_{\xi} g) (\operatorname(\operatorname{grad}_h \ln f, X) + g(\hat{\nabla}_{\xi} \operatorname{grad}_h \ln f, X) + g(\operatorname{grad}_h \ln f,  \hat{\nabla}_{\xi} X).
\end{split}
\]
Rearranging gives,
\[
\begin{split}
-g(\hat{\nabla}_{\xi} \operatorname{grad}_h \ln f, X) &= -\hat{\nabla}_{\xi} \left(X(f)\right) + (\hat{\nabla}_{\xi} g) (\operatorname(\operatorname{grad}_h \ln f, X) + g(\operatorname{grad}_h \ln f,  \hat{\nabla}_{\xi} X) \\
&= X(\partial_t f) + (\hat{\nabla}_{\xi} g) (\operatorname(\operatorname{grad}_h \ln f, X) + g(\operatorname{grad}_h \ln f,  A(X))
\end{split}
\]
The first term is,
\[
\begin{split}
X(\partial_t f) &= X\left[|p|(f\mathcal{H} + \operatorname{tr} (\widehat{Rm}(\xi,\cdot,\cdot,\nu)))\right] \\
&= |p| h(f \operatorname{grad}_h \mathcal{H} + \mathcal{H} \operatorname{grad}_h f, X) + |p| h(\operatorname{grad}_h \operatorname{tr} \left(\widehat{Rm}(\xi, \cdot, \cdot, \nu)\right), X)
\end{split}
\]
whilst the second terms is
\[
\begin{split}
(\hat{\nabla}_{\xi} g) (\operatorname(\operatorname{grad}_h \ln f, X) &= -\frac{p}{|p|} g(A(\operatorname{grad}_h \ln f), X)  -
|p|g(\operatorname{grad}_h \ln f, X) \mathcal{H} \\
&\quad + \frac{p}{|p|f}\langle \widehat{Rm}(\xi,Y)X,\nu\rangle + \frac{1}{f}\operatorname{tr} (\widehat{Rm}(\xi,\cdot,\cdot,\nu))) g(\operatorname{grad}_h \ln f, X)\\
\end{split}
\]
...
\[
\begin{split}
- \hat{\nabla}_{\xi} \operatorname{grad}_h \ln f &= |p| f \operatorname{grad}_h \mathcal{H} + \mathcal{H} \operatorname{grad}_h f - \frac{p}{|p|} A(\operatorname{grad}_h \ln f)  -
|p|\operatorname{grad}_h \ln f \mathcal{H} \\
\end{split}
\]
There are also these terms which I need to sort out:
\[
\begin{split}
g(\operatorname{grad}_h \ln f,  A(X)) \\
+ \frac{p}{|p|f}\langle \widehat{Rm}(\xi,Y)X,\nu\rangle + \frac{1}{f}\operatorname{tr} (\widehat{Rm}(\xi,\cdot,\cdot,\nu)))g(\operatorname{grad}_h \ln f, X) \\
+ |p| \operatorname{grad}_h \operatorname{tr} \left(\widehat{Rm}(\xi, \cdot, \cdot, \nu)\right) 
\end{split}
\]
